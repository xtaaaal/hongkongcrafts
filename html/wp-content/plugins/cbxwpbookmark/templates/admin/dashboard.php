...
<div class="wrap">
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX WP Bookmark - Dashboard"
                     src="<?php echo CBXWPBOOKMARK_ROOT_URL . 'assets/img/icon_log.svg'
				     ?>" alt="CBX WP Bookmark - Dashboard" width="32" height="32">
                <h2 class="wp-heading-inline wp-heading-inline-setting">
					<?php esc_html_e( 'CBX WP Bookmark - Dashboard', 'cbxwpbookmark' ); ?>
                    <!--<a href="#" id="save_settings" class="button button-primary"><?php /*esc_html_e('Save Settings', 'cbxwpbookmark'); */ ?></a>-->
                </h2>
            </div>
            <a href="<?php echo admin_url() . 'admin.php?page=cbxwpbookmark_settings' ?>" class="button button-primary
            save-settings"> <?php esc_html_e( 'Go to Settings', 'cbxchangelog' ); ?><img
    ...
    <div class="cbx-backend_container" style="background: transparent">
        <div class="cbx-backend_wrapper cbxwpbookmark_dashboard_wrapper">
            <div class="cbx-backend-row">
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                                    ...
                                    <div class="cbx-backend-feature-card">
                                        <div class="feature-card-body static">
                                            ...
                                            <div class="feature-card-description">
                                                ...
                                                <p>This plugin integrates CBX Bookmark plugin with myCred plugin. Users
                                                    gets point by bookmarking a
                                                    post</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="cbx-backend-card dashboard-plugin-Integration">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Third Party plugin Integration', 'cbxwpbookmark' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                ...
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                        ...
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
									...
									<?php esc_html_e( 'Access our Premium Support', 'cbxwpbookmark' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Bookmark"
                                   target="_blank">
									...
									<?php esc_html_e( 'Quick Support(Email)', 'cbxwpbookmark' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $plugin_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'CBX WP Bookmark Plugin Information', 'cbxwpbookmark' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'Read the CBX WP Bookmark User Guide', 'cbxwpbookmark' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxwpbookmark/reviews/#new-post"
                                   target="_blank">
                                    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<?php esc_html_e( 'Rate Our Plugin', 'cbxwpbookmark' ); ?> </a>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Changelog', 'cbxwpbookmark' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <p>
                                    Version - 1.6.13
                                    <span class="release_date">27 Sep, 2021</span>
                                </p>
                                <ul>
                                    <li>[improvement] userid param in shortcode or in url (?userid=) is checked everywhere with better logic</li>
                                    <li>[proaddon] there is update in pro addon, pls upgrade</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li>[improvement] auto integration is disabled in dashboard if 'the_content' is fired in dashboard somehow</li>
                                    <li>[proaddon] there is update in pro addon, pls upgrade</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li>[improvement] added object id or post id in bookmark listing table in plugin dashboard for easy understanding</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li>[fixed] select2 library loaded perfectly in all widgets and places.</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li>[improvement] $_REQUEST['page'] escaped with esc_url , issue pointedby wpscan.com</li>
                                </ul>
                            </div>
