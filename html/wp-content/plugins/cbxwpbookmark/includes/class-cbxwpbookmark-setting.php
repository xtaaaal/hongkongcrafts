...
if ( ! class_exists( 'CBXWPBookmark_Settings_API' ) ):
	...
	class CBXWPBookmark_Settings_API {
		...
		function callback_heading( $args ) {
			...
			$html = '<h3 class="setting_heading"><span class="setting_heading_title">' . $args['name'] . '</span><a title="' . esc_attr__( 'Click to show hide', 'cbxwpbookmark' ) . '" class="setting_heading_toggle" href="#">' . esc_attr__( 'Click to show hide', 'cbxwpbookmark' ) . '</a></h3>';
                    ...
                    <div id="<?php echo $form['id']; ?>" class="global_setting_group" style="<?php echo $display_style; ?>">
                        <form method="post" action="options.php" class="cbxwpbookmark_setting_form">
                            ...
                            <div style="padding-left: 10px">
								<?php submit_button( esc_html__( 'Save Settings', 'cbxwpbookmark' ), 'primary submit_cbxwpbookmark', 'submit', true, array( 'id' => 'submit_' . esc_attr( $form['id'] ) ) ); ?>
                            </div>
                        </form>
                    </div>
					<?php
