...
class BP_Better_Messages_Options
{
    ...
    public function update_settings( $settings )
    {
        ...
        $links_allowed = [ 'restrictBadWordsList', 'restrictNewThreadsMessage', 'restrictNewRepliesMessage', 'restrictViewMessagesMessage', 'rateLimitReplyMessage', 'myCredNewMessageChargeMessage', 'myCredNewThreadChargeMessage' ];
